...
function toTreeItem(node: XsdNode): TreeViewDataItem {
    return {
        ...
        name: (
            ...
            >
                ...
                {node.warning && (
                    <Badge style={{ marginLeft: 4, backgroundColor: 'var(--pf-v5-global--warning-color--100)' }}>!</Badge>
                )}
            </span>
        ),
        defaultExpanded: true,
        children: node.children.length > 0 ? node.children.map(toTreeItem) : undefined,
    };
}
